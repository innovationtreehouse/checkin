...
-- See docs/designs/PROGRAM_INSTANCE_RESTRUCTURE.md (§7 P1). This migration ONLY
-- adds: the ProgramInstance table, a nullable Event.instanceId FK, and a 1:1
-- backfill. It moves NO child FK, drops NO column, renames nothing — every
-- destructive/rename step (P2–P5) is a later release per
-- DEPLOY_MIGRATION_ORDER_OF_OPERATIONS.md (expand-contract).
--
...
-- BACKFILL markers below and runs it twice — keep the markers exact.
-- >>> BACKFILL START
