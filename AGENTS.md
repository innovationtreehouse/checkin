...
- `MIGRATION_COALESCE_FLOW.md` — the migration-coalesce script (`scripts/coalesce-migrations.ts`) for squashing a long unreleased tail, and the dev/prod ledger-reconcile procedure.
