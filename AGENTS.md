...
- `PROGRAM_CALENDAR_EXPORT.md` — "Add to calendar" for a program's events (hand-rolled `.ics` + Google Calendar template links); read before touching `lib/calendar/` or the program-detail schedule affordance.
